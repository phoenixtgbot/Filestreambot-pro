...
class Var(object):
    ...
    BOT_TOKEN = str(getenv('BOT_TOKEN',"5460906870:AAETwDoM_u7SdqtvzChlmBPZxUaLTIe1iRw"))
    ...
    DATABASE_URL = str(getenv('DATABASE_URL',"mongodb+srv://PhoenixKing:PhoenixKing@cluster0.ajwkdee.mongodb.net/?retryWrites=true&w=majority"))
